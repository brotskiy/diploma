...
double intSinCosSin(const int i, const int ii, const int ik, const double a)
{
  ...
  if (ik == ii - i)
  {
    if (i != ii)
      ...
      return -101;     // маркер. в теории сюда никогда не должно дойти, т.к 0<ik=ii-ii=0 ПРОТИВОРЕЧИЕ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  }
  ...
  if (ik == i - ii)
  {
    if (i != ii)
      ...
      return -10101;   // маркер. в теории сюда никогда не должно дойти, т.к 0<ik=i-i=0 ПРОТИВОРЕЧИЕ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  }

  return -10101010101; // маркер. в теории сюда никогда не должно дойти, т.к. все варианты перебрали!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
}
